...
from app.agents.base import AgentConfig, FederalJobAgent
from app.agents.roles.data_scientist import DataScientistAgent  # Original broken agent
from app.agents.roles.data_scientist_fixed import create_fixed_data_scientist_agent  # Fixed agent
